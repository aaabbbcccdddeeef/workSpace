 ...
 */
//获取温湿度的设备字典参数
 var options=optionApi.getOption('dg')
 //打印出设备字典对应参数
//  console.log(options)
...
if(type==='read') {
  ...
  var read_code
  var newRead=newXy.read(addr, ["2501","2509","2510","2506"])
  /**
   * 输出查询的指令数组
  ...
  */
  ...
  var readS = [
    ' 01 03 18 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 6C F4  '.split(' ').join(''),
  ]
