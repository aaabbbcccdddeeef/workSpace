...
var optionApi=require('../utils/options');

//加载协议文件js
//可以修改成指定协议
var str=require('./index.source');

/*
*基本参数
*/
//获取温湿度的设备字典参数
var options=optionApi.getOption('jz')
//打印出设备字典对应参数
//  console.log(options)
...
// 用于调用下对应的方法
var type='read'  // find, read ,write,decode
...
if(type==='read') {
    ...
    //"3701","3702","3703","3704"   电池余量
    //"4301","4302","4303","4304"   超声波有效值
    //"4101","4104"  超声波最大值
    //"4901","4902" 暂态性低压
    var read_code
    var newRead=newXy.read(addr, ["3701","3702","3703","3704"  ])
    /**
     * 输出查询的指令数组
    ...
    var readS = [
        '0103080057005a005700585b35 '.split(' ').join(''),
    ]
...
if(type==='write') {
    ...
    var writeS = [
        //  '01 06 00 06 00 03 29 CA'.split(' ').join(''),
    ]
